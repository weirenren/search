...
public class LoginActivity extends BaseActivity implements View.OnClickListener, TextWatcher {
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.iv_login_showpassword) {
            showOrHidePassword();

        } else if (i == R.id.btn_login_login) {
            login();

        } else if (i == R.id.ll_login_sina) {
            sinaLogin();

        } else if (i == R.id.ll_login_qq) {
            qqLogin();

        } else if (i == R.id.rl_login_register) {
            register();

        } else if (i == R.id.rl_login_forgotpassword) {
            forgotPassword();

        } else if (i == R.id.tv_login_agreement) {
            readUserAgreement();
