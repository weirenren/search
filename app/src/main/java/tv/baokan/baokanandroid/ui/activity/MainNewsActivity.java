...
import tv.baokan.baokanandroid.ui.fragment.SNewsFragment;
...
public class MainNewsActivity extends BaseActivity {
    ...
    private void prepareFragments() {
        ...
        mBaseFragments.add(new SNewsFragment());
    ...
    private void setItemListener() {
        mRgTabbar.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.rb_news_item) {
                    position = 0;

                } else if (checkedId == R.id.rb_photo_item) {
                    position = 1;

                } else if (checkedId == R.id.rb_hot_item) {
                    position = 2;

                } else if (checkedId == R.id.rb_profile_item) {
                    position = 3;
