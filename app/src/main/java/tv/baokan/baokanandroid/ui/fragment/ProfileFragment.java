...
//            portraitImageView.setImageURI("");
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.ll_profile_portrait_layout) {
            if (UserBean.isLogin()) {
        ...
        } else if (i == R.id.ll_profile_collection_layout) {
            if (UserBean.isLogin()) {
        ...
        } else if (i == R.id.ll_profile_comment_layout) {
            if (UserBean.isLogin()) {
        ...
        } else if (i == R.id.ll_profile_info_layout) {
            if (UserBean.isLogin()) {
                UserInfoActivity.start(getActivity());
            } else {
                LoginActivity.start(getActivity());
        ...
        } else if (i == R.id.rl_profile_clear_cache_layout) {
            showClearCacheDialog();

        } else if (i == R.id.rl_profile_set_font_layout) {
            showSetFontDialog();

        } else if (i == R.id.rl_profile_feekback_layout) {
            FeedbackActivity.start(getActivity());

        } else if (i == R.id.rl_profile_aboutme_layout) {
            AboutUsActivity.start(getActivity());

        } else if (i == R.id.rl_profile_commend_layout) {
            showShareApp();
