...
//        mContentWebView.setLayerType(View.LAYER_TYPE_HARDWARE, null);
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.ib_news_detail_bottom_bar_back) {
            finish();

        } else if (i == R.id.ib_news_detail_bottom_bar_edit) {
            showCommentDialog();

        } else if (i == R.id.ib_news_detail_bottom_bar_font) {
            showSetFontDialog();

        } else if (i == R.id.ib_news_detail_bottom_bar_collection) {
            collectArticle();

        } else if (i == R.id.ib_news_detail_bottom_bar_share) {// 弹出分享ui
            showShare(null);

        } else if (i == R.id.ll_article_content_share_qq) {// qq分享
            showShare(ShareSDK.getPlatform(QQ.NAME).getName());

        } else if (i == R.id.ll_article_content_share_weixin) {// 微信分享
            showShare(ShareSDK.getPlatform(Wechat.NAME).getName());

        } else if (i == R.id.ll_article_content_share_pyq) {// 朋友圈分享
    ...
    private void showSetFontDialog() {
        ...
        setFontGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (checkedId == R.id.rb_set_font_verybig) {
                    fontSize = 22;

                } else if (checkedId == R.id.rb_set_font_big) {
                    fontSize = 20;

                } else if (checkedId == R.id.rb_set_font_middle) {
                    fontSize = 18;

                } else if (checkedId == R.id.rb_set_font_small) {
                    fontSize = 16;
