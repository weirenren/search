...
public class PhotoDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.ib_photo_detail_bottom_bar_back) {
            finish();

        } else if (i == R.id.ib_photo_detail_bottom_bar_edit) {
            showCommentDialog();

        } else if (i == R.id.ib_photo_detail_bottom_bar_comment) {
            CommentListActivity.start(mContext, classid, id, null, "photo");

        } else if (i == R.id.ib_photo_detail_bottom_bar_collection) {
            collectArticle();

        } else if (i == R.id.ib_photo_detail_bottom_bar_share) {
            share();

        } else if (i == R.id.tv_photo_detail_report) {
